...
public class DLinkedList {
	...
	public void insertionSort(){
		...
		//traverse the doubly linked list and insert nodes to sortedList
	
		Node j = headNode.nextNode;
		while (j != null)
		{
			//Store the nextNode for upcoming iterations
			Node nextNode = j.nextNode;
			Node k = j.prevNode;
			//remove links to create a new node for insertion
			int i = delete(j);
			//insert currentNode into sortedList
			while (k != null && k.value > i) {
				k = k.prevNode;
